...
class TestSensitivities(unittest.TestCase):
    ...
    def test_R0_max_infectious_sensitivity(self):
        self.assertAlmostEqual(119334.496, self.sensitivities['R0']['max_infectious'], 2)

    def test_R0_max_infectious_time_sensitivity(self):
        self.assertAlmostEqual(-20.054, self.sensitivities['R0']['max_infectious_time'], 2)

    def test_R0_max_hospitalized_sensitivity(self):
        self.assertAlmostEqual(104.787, self.sensitivities['R0']['max_hospitalized'], 2)

    def test_R0_max_hospitalized_time_sensitivity(self):
        self.assertAlmostEqual(-25.068, self.sensitivities['R0']['max_hospitalized_time'], 2)

    def test_R0_cumulative_infected_sensitivity(self):
        self.assertAlmostEqual(587426.43, self.sensitivities['R0']['cumulative_infected'], 2)

    def test_R0_cumulative_hospitalized_sensitivity(self):
        self.assertAlmostEqual(536.635, self.sensitivities['R0']['cumulative_hospitalized'], 2)

    def test_R0_deaths_sensitivity(self):
        self.assertAlmostEqual(39.359, self.sensitivities['R0']['deaths'], 2)

    def test_avg_days_infected_max_infectious_sensitivity(self):
        self.assertAlmostEqual(5029.437, self.sensitivities['avg_days_infected']['max_infectious'], 2)

    def test_avg_days_infected_max_infectious_time_sensitivity(self):
        self.assertAlmostEqual(-18.0494, self.sensitivities['avg_days_infected']['max_infectious_time'], 2)

    def test_avg_days_infected_max_hospitalized_sensitivity(self):
        self.assertAlmostEqual(2.358, self.sensitivities['avg_days_infected']['max_hospitalized'], 2)

    def test_avg_days_infected_max_hospitalized_time_sensitivity(self):
        self.assertAlmostEqual(-18.5508, self.sensitivities['avg_days_infected']['max_hospitalized_time'], 2)

    def test_avg_days_infected_cumulative_infected_sensitivity(self):
        self.assertAlmostEqual(25729.668, self.sensitivities['avg_days_infected']['cumulative_infected'], 2)

    def test_avg_days_infected_cumulative_hospitalized_sensitivity(self):
        self.assertAlmostEqual(23.08, self.sensitivities['avg_days_infected']['cumulative_hospitalized'], 2)

    def test_avg_days_infected_deaths_sensitivity(self):
        self.assertAlmostEqual(1.792, self.sensitivities['avg_days_infected']['deaths'], 2)